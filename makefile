...
OBJ = main.o course.o courseBST.o courseNode.o courseLinkedList.o degree.o degreeArrayList.o department.o degreeReq.o deptArrayList.o
unitTest = unitTest.o courseBST.o course.o courseNode.o courseLinkedList.o department.o degreeReq.o degree.o degreeArrayList.o
